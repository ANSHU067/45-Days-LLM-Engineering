# Day 07 — Coding Challenge Day · All 15 Questions (Days 1–6 recap)

All problem stubs in one place. Copy a block into a `.py` file (or open the matching
`qNN_*.py` stub) and fill in the `# TODO`s. Worked answers live in `qNN_*_solution.py`.

---

## Day 1 — Variables, numbers & operators

### Problem 01 — Seconds to H:M:S
...
### Problem 04 — Palindrome check (strings)
...
### Problem 09 — Star triangle pattern
...
### Problem 12 — Number stats with *args
...
### Problem 14 — Compare two lists with sets
...
### Problem 15 — Class gradebook (capstone)
